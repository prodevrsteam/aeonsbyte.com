...
// fix: Add onClick prop to AeonsbyteLogo to handle click events.
export const AeonsbyteLogo: React.FC<{ className?: string; onClick?: () => void; }> = ({ className, onClick }) => (
  <svg className={className} viewBox="0 0 160 28" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClick}>
    <text x="0" y="22" fontFamily="Verdana, sans-serif" fontSize="24" fill="white" fontWeight="bold">aeonsbyte</text>
  </svg>
);
