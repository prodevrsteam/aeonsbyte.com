        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex items-center space-x-6">
              <a href="#" className="hover:opacity-80 transition-opacity"><FacebookIcon className="h-6 w-6" /></a>
              <a href="#" className="hover:opacity-80 transition-opacity"><InstagramIcon className="h-6 w-6" /></a>
              <a href="#" className="hover:opacity-80 transition-opacity"><LinkedInIcon className="h-6 w-6" /></a>
              <a href="#" className="hover:opacity-80 transition-opacity"><YoutubeIcon className="h-6 w-6" /></a>
            </div>
          </div>
        </div>
